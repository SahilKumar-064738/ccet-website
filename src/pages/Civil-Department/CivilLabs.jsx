    ...
    <SharedCivilLayout pageTitle="Laboratories">
      <div className={styles.container}>
        <header>
          ...
          <p className={styles.CivilintroText}>
            At Civil Department, students are challenged by a flexible,
            ...
            technological area, Department of Civil have well equipped computer
